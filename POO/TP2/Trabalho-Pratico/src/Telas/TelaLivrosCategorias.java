...
public class TelaLivrosCategorias extends javax.swing.JDialog {
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        this.modeloCategoriasLivro.deletarCategoriaLivro(categoriaRemover, daoLivro.localizar(livro.getId()));
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        Categoria categoriaLista = daoCategoria.localizar(id);
        
        //Verificando se a categoria ja existe nos dados e, se existir, nao adicionar
        if(livro.getCategoria().indexOf(categoriaLista) == -1){
            daoLivro.adicionarCategoria(livro.getId(), categoriaLista);
            //modeloCategoriasLivro.addCategoriaLivro(categoriaLista, daoLivro.localizar(livro.getId()));
            tableCategoriasLivro.updateUI();
        }
